...
class CoralPresetNameEditor : public Component, private TextEditor::Listener
{
public:
	...
	CoralPresetNameEditor();
	~CoralPresetNameEditor() = default;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CoralPresetNameEditor)
};
