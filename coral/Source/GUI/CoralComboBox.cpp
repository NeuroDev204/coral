...
void CoralComboBox::highlightText(bool highlight)
{
    auto& theme = dynamic_cast<LookAndFeel_V4&>(getLookAndFeel());
...
bool CoralComboBox::getError()
{
    return error_;
}

void CoralComboBox::setError(bool enable)
{
    if (enable)
    {
        error_ = true;
