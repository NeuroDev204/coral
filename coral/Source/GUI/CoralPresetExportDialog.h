...
/*
*/
class CoralPresetExportDialog : public CoralWindow
{
public:
    CoralPresetExportDialog();
    ~CoralPresetExportDialog() = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CoralPresetExportDialog)
};
