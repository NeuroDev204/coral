...
CoralMessage::CoralMessage(String message, const std::pair<String, String>& link) : message_content_(message, link)
{
...
bool CoralMessage::keyPressed(const KeyPress& key)
{
...
void CoralMessage::closeButtonPressed()
{
	exitModalState(0);
	removeFromDesktop();
}

void CoralMessage::showMessage(String message, const std::pair<String, String>& link)
{
	CoralMessage message_window(message, link);
	message_window.runModalLoop();
}

CoralMessage::MessageComponent::MessageComponent(String message, const std::pair<String, String>& link)
{
...
void CoralMessage::MessageComponent::resized()
{
