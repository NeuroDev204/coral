...
enum CoralThemeMode : int {Dark=0, Light, NumModes};
enum CoralColor : int { WindowBackground, WidgetBackground, MenuBackground, Outline, DefaultText, DefaultFill, HighlightedText, HighlightedFill, MenuText,
...
enum CoralImage : int { DefaultLogo, HighlightedLogo, IconLogo,
...
class CoralTheme : public LookAndFeel_V4
{
public:
	...
	static CoralThemeMode getThemeMode();
	static void setThemeMode(CoralThemeMode theme_mode);
	static uint32 getColor(CoralColor color);
	static const char* getImage(CoralImage image);
	static const int getImageSize(CoralImage image);
...
private:
	...
	static const uint32 theme_colors_[CoralThemeMode::NumModes][CoralColor::NumColors];
	static const char* theme_images_[CoralThemeMode::NumModes][CoralImage::NumImages];
	static const int theme_image_sizes_[CoralThemeMode::NumModes][CoralImage::NumImages];
	static CoralThemeMode theme_mode_;

	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CoralTheme)
};

#define FXCOLOR(color) (CoralTheme::getColor(CoralColor::color))
#define FXIMAGE(image) (CoralTheme::getImage(CoralImage::image))
#define FXIMAGESIZE(image) (CoralTheme::getImageSize(CoralImage::image))
