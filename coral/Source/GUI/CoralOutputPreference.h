...
class CoralOutputPreferenceListModel;

class CoralOutputDeviceRow : public Component
{
public:
    explicit CoralOutputDeviceRow(CoralOutputPreferenceListModel& model);
...
private:
    ...
    CoralOutputPreferenceListModel& output_preference_list_model_;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CoralOutputDeviceRow)
};

class CoralOutputPreferenceListModel : public ListBoxModel, public CoralModel::Listener
{
public:
    CoralOutputPreferenceListModel();
    ~CoralOutputPreferenceListModel();
    ...
    void modelChanged(CoralModel::Event event) override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CoralOutputPreferenceListModel)
};


class CoralOutputPreference : public Component, public KeyListener
{
public:
    CoralOutputPreference();
...
private:
    ...
    CoralOutputPreferenceListModel output_preference_model_;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CoralOutputPreference)
};
