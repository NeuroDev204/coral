...
CoralPresetNameEditor::CoralPresetNameEditor()
{
...
void CoralPresetNameEditor::resized()
{
...
void CoralPresetNameEditor::paint(Graphics& g)
{
...
void CoralPresetNameEditor::textEditorTextChanged(TextEditor& textEditor)
{
...
void CoralPresetNameEditor::lookAndFeelChanged()
{
	repaint();
}