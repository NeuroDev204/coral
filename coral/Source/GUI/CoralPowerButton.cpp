...
CoralPowerButton::CoralPowerButton(const String &button_name) : DrawableButton(button_name, DrawableButton::ButtonStyle::ImageFitted)
{
	power_state_ = false;
...
void CoralPowerButton::paint(Graphics& g)
{
...
bool CoralPowerButton::keyPressed(const KeyPress& key)
{
...
void CoralPowerButton::lookAndFeelChanged()
{
	power_on_image_ = Drawable::createFromImageData(FXIMAGE(PowerOnButton), FXIMAGESIZE(PowerOnButton));
	power_off_image_ = Drawable::createFromImageData(FXIMAGE(PowerOffButton), FXIMAGESIZE(PowerOffButton));
	repaint();
...
bool CoralPowerButton::getPowerState()
{
	return power_state_;
}

void CoralPowerButton::setPowerState(bool power_state)
{
	power_state_ = power_state;
	repaint();
}

int CoralPowerButton::getImageWidth()
{
	return image_width_;
}

void CoralPowerButton::setImageWidth(int image_width)
{
