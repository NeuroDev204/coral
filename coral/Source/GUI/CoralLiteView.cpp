...
void CoralLiteView::startVisualizer()
{
	visualizer_.start();
}

void CoralLiteView::pauseVisualizer()
{
	visualizer_.pause();
}

void CoralLiteView::resized()
{
...
void CoralLiteView::paint(Graphics& g)
{
	auto area = getLocalBounds().reduced(24, 20);
	...
	CoralTheme::paintGlassCard(g, playback.toFloat(), r);
	CoralTheme::paintGlassCard(g, enhance.toFloat(), r);
