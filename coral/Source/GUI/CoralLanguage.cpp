...
CoralLanguage::CoralLanguage() : next_button_("next", DrawableButton::ButtonStyle::ImageFitted), prev_button_("prev", DrawableButton::ButtonStyle::ImageFitted)
{
    languages_ = { "en", "ar", "ba", "hr", "cs", "de", "es", "fi", "fr", "hu", "id", "it", "ja", "ko", "nl", "no", "fa", "pl", "pt", "pt-br", "ro", "ru", "sl", "sv", "th", "tr", "ua", "vi", "zh-CN", "zh-TW"};
    ...
    String language_code = CoralController::getInstance().getLanguage();
    language_.setText(CoralController::getInstance().getLanguageName(language_code), NotificationType::dontSendNotification);
...
void CoralLanguage::onNextLanguage()
{
    ...
    CoralController::getInstance().setLanguage(language_code);
...
void CoralLanguage::onPrevLanguage()
{    
