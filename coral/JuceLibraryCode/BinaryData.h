...
namespace BinaryData
{
    ...
    const int            flip_svgSize = 575;

    extern const char*   flip_black_svg;
    const int            flip_black_svgSize = 587;

    extern const char*   flip_blue_svg;
    const int            flip_blue_svgSize = 586;

    extern const char*   flip_white_svg;
    const int            flip_white_svgSize = 587;

    extern const char*   arrow_down_black_svg;
    const int            arrow_down_black_svgSize = 250;

    extern const char*   arrow_down_white_svg;
    const int            arrow_down_white_svgSize = 250;

    extern const char*   arrow_up_black_svg;
    const int            arrow_up_black_svgSize = 251;

    extern const char*   arrow_up_white_svg;
    const int            arrow_up_white_svgSize = 251;
    ...
    const int            donate_blue_svgSize = 422;

    extern const char*   donate_hover_blue_svg;
    const int            donate_hover_blue_svgSize = 422;
    ...
    const int            donate_svgSize = 422;

    extern const char*   donate_hover_svg;
    const int            donate_hover_svgSize = 422;
