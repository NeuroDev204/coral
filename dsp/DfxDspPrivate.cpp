...
DfxDspPrivate::DfxDspPrivate()
{
	...
	swprintf(product_specific_.wcp_registry_product_name, PT_MAX_GENERIC_STRLEN, PT_WF, DFXG_REGISTRY_DFX_PRODUCT_NAME_WIDE);
	swprintf(product_specific_.wcp_displayed_product_name, PT_MAX_GENERIC_STRLEN, PT_WF, DFXG_DISPLAYED_DFX_PRODUCT_NAME_WIDE);
