...
// "Coral.exe", matched case-insensitively) currently has a running
...
// IsCoralRunning reports whether Coral.exe is currently running.
//
// This gates any command that CoralController.cpp's applyConfig only honors
...
func IsCoralRunning() (bool, error) {
	return IsProcessRunning("Coral.exe")
}
