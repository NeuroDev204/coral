...
const (
	...
	// ErrKindAppNotFound means Coral.exe or fxdiag.exe could not be
	...
	// EnsureRunning could not bring Coral up or confirm it responsive
	// in time.
	ErrKindRequiresRunningInstance
	// ErrKindValueRejected means CoralController.cpp's applyConfig would have
